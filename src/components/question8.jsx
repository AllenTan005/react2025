...
const question8 = () => {
  ...
  const totalStudyPointsFromTodos = todos.reduce(
    (sum, todo) => sum + todo.studyPoint,
    0
  );
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <a
            href="https://github.com/AllenTan005/react2025/blob/main/src/components/question8.jsx"
            target="_blank"
